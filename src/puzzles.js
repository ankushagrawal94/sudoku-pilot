...
export const TECHNIQUE_DESCRIPTIONS = {
  ...
  "Naked Pair": "Two cells have only two candidates between their combined lists. Those digits must occupy the cells, so remove them from the rest of the row, column, or block.",
  ...
  "Hidden Pair": "The combined possible positions for two digits occupy exactly two cells. Reserve those cells for the chosen digits and remove the other notes there.",
  "Hidden Triple": "The combined possible positions for three digits occupy exactly three cells. Reserve those cells for the chosen digits and remove the other notes there.",
