...
function brokenRecognitionRule(technique) {
  return ({
    ...
    "Hidden Pair": "The combined possible positions for the two digits no longer occupy exactly two cells in one row, column, or block.",
    "Naked Triple": "The outline no longer shows three cells in one row, column, or block using only three digits between them.",
    "Hidden Triple": "The combined possible positions for the three digits no longer occupy exactly three cells in one row, column, or block.",
